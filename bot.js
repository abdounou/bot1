 ...
 **
رابط البوت | https://discordapp.com/api/oauth2/authorize?client_id=527930979982245903&permissions=0&scope=bot
`);
  message.author.sendEmbed(embed);
   }
});
 ...
 **
رابط السيرفر | https://discord.gg/sUChSMT
 **
`);
  message.author.sendEmbed(embed);
   }
...
client.on('message', msg => {
  if (msg.content === '.') {
    msg.channel.send(' **__-Wèlçomè Ťø LORDS GAMING Śeŕveŕ__** ');
  }
});
...
client.login('NTI3OTMwOTc5OTgyMjQ1OTAz.Dwa6GQ.O4goVaKuwgr_iVl4hOl-TgSkPtM');
